...
"""
Run MagiClaw with teleoperating mode.

This script starts the MagiClaw to run in teleoperating mode.
...
It publishes the data to the specified address, including:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run MagiClaw in teleoperating mode.")
